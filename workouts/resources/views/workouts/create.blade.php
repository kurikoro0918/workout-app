...
<div class="container mx-auto p-4 md:p-8">
    ...
    <header class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-2">新しい記録を追加</h1>
        <p class="text-gray-600">今日のワークアウトを記録しよう。</p>
    </header>
    ...
    <div class="bg-white p-6 rounded-xl shadow-md max-w-xl mx-auto">
        <form action="{{ route('workouts.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="exercise_name" name="exercise_name" value="{{ old('exercise_name') }}" placeholder="例：ベンチプレス" class="w-full bg-gray-50 text-gray-900 border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition duration-200">
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="number-input-container">
                    <label for="weight" class="block text-sm font-medium text-gray-600 mb-1">重量 (kg)</label>
                    <input type="number" id="weight" name="weight" value="{{ old('weight') }}" placeholder="0" class="w-full bg-gray-50 text-gray-900 border border-gray-300 rounded-lg py-2 px-3 pr-10 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition duration-200">
                ...
                <div class="number-input-container">
                    ...
                    <input type="number" id="reps" name="reps" value="{{ old('reps') }}" placeholder="0" class="w-full bg-gray-50 text-gray-900 border border-gray-300 rounded-lg py-2 px-3 pr-10 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition duration-200">
                ...
                <div class="number-input-container">
                    ...
                    <input type="number" id="sets" name="sets" value="{{ old('sets') }}" placeholder="0" class="w-full bg-gray-50 text-gray-900 border border-gray-300 rounded-lg py-2 px-3 pr-10 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition duration-200">
            ...
            <div>
                ...
                <textarea id="notes" name="notes" rows="4" placeholder="今日の調子はどうだった？" class="w-full bg-gray-50 text-gray-900 border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition duration-200">{{ old('notes') }}</textarea>
            </div>
